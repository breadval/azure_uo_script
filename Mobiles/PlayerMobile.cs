			...
			if (AccessLevel > AccessLevel.Player)
  			{
 		 		...
 		 		case AccessLevel.Counselor: 
					...
					list.Add( 1060658, "{0}\t{1}", "Counselor", String.Format("<BASEFONT COLOR={0}>{1}", color, AccessLevel) );
					break;
 		 		case AccessLevel.GameMaster: 
					color = "#FF0000";  	//Red
					list.Add( 1060658, "{0}\t{1}", "GM", String.Format("<BASEFONT COLOR={0}>{1}", color, AccessLevel) );
					break;
 		 		case AccessLevel.Seer: 
					color = "#00FF00";  	//Green
					list.Add( 1060658, "{0}\t{1}", "Seer", String.Format("<BASEFONT COLOR={0}>{1}", color, AccessLevel) );
					break;
 		 		case AccessLevel.Administrator: 
					color = "#FFD700";  	//Gold
					list.Add( 1060658, "{0}\t{1}", "Moderator", String.Format("<BASEFONT COLOR={0}>{1}", color, AccessLevel) );
					break;
	 		    	case AccessLevel.Developer: 
					color = "#FFD700";  	//Gold
					list.Add( 1060658, "{0}\t{1}", "Creator", String.Format("<BASEFONT COLOR={0}>{1}", color, AccessLevel) );
					break;
	 		    	case AccessLevel.Owner: 
					color = "#FFD700";  	//Gold
					list.Add( 1060658, "{0}\t{1}", "God", String.Format("<BASEFONT COLOR={0}>{1}", color, AccessLevel) );
					break;
  				}
